...
# Pontos de controle da curva Bézier (Grau da curva será núm. de pontos + 1)
...
while bezier:
    ...
    # Ajustar o último ponto de controle da curva Bézier e o primeiro ponto de controle da curva NURBS
    # para obter continuidade C1
    pontosControleNurbs[0] = pontosControleBezier[-1] + (pontosControleBezier[-1] - pontosControleBezier[-2])
